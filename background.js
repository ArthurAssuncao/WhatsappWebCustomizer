...
var constants = {
    ...
    BG_PANEL_HEADER: {selector: {main: ".pane-header", bgchatlist: '.pane-one .chatlist-panel-body .infinite-list-viewport', search: '.pane-one .search-container', chat: '.chat-drag-cover .chat'}, add: "addBgPanelHeader", remove: "removeBgPanelHeader"},
    ...
    CHAT_TITLE: {selector: {main: ".pane-one .chatlist-panel-body .chat-body .chat-title, .pane-two .chat-body .chat-title", chattime: '.pane-one .chatlist-panel-body .chat-body .chat-time', chatstatus: '.pane-one .chatlist-panel-body .chat-body .chat-status, .pane-two .chat-body .chat-status', chatbody: '.pane-one .chatlist-panel-body .chat-body'}, add: "addChatTitle", remove: "removeChatTitle"},
